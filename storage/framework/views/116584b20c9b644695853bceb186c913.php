...
<head>
    ...
    <title>BOOSTRAP CLONE BY MUHAMMAD ZIDAN</title>
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>"  style="width: 40px;">
            </a>
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                <button type="button" class="btn nav-link text-white drpdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container py-5 px-4">
        <div class="row">
            ...
            <div class="col-md-7 order-md-1">
                <h1 class="nt-4 display-3">Build fast, responsive sites with Bootstrap</h1>
                <p class="fs-5 mt-3">Quickly desaign and customize responsive mobile-first sites with Bootstrap, the world most popular front-end open source
                    toolkit, featuring sass variables and mixins, responsive grid system, extensive probuilt components, and powerfull JavaScript plugings </p>
                <div class="row">
                    <div class="d-flex flex-coloumn flex-and-row">
...
<div id="bs-icons">
    ...
    <div class="container py-5 px-4">
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-3">
                    <i class="bi bi-substract fs-2 bg-warning py-2 px-3 rounded-3 text-white"></i>
                </div>
                <h2 class="display-5 mb-3">Personalize it with <br/>Boostrab Icons</h2>
                <p class="fs-5"><a href="#">Bootstrab Icons</a> is an open source SVG icon library featuring over 1,800 glyphs, with more added every
                release. They are designed to work in any project, whether you use Bootstrab itself or not. Use them as SVGs or icon fonts--both option give you vector scaling and easy customization via CSS</p>
                <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Get Bootstrap Icons
                    <i class="bi bi-arrow-right mb-2"></i>
                </a>
            </div>
            <div class="col-lg-6">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/bs-icons.png')); ?>" alt="Boostrab Icons">
            </div>
        </div>
    </div>
</div>
<!--Boostrab Official Themes-->
<div id="bs-themes">
    <!--Container-->
    <div class="container py-5 px-4">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h2 class="display-5">Make it yours with official Bootstrab Themes</h2>
                <p class="fs-5">Take Bootstrap to the next level with premiums themes from the <a href="#">official Bootsrab Themes Marketplace</a>. Themes
                are built on bootsrab as their own extended frameworks, rich with new components, plugins, documentation and powerfull build tools.</p>
                <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Browse Bootstrab Themes
                    <i class="bi bi-arrow-right mb-2"></i>
                </a>
            </div>
            <div class="col-lg-6">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/bs-themes.png')); ?>" alt="Bootstrab Themes">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                <a href="#" class="logo text decoration none">
                    <div class="d-flex">
                        <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>" alt="Bootstrab Logo" style="width: 40px;">
                        <div class="fs-5 ms-2 text-black">Bootstrap</div>
                    </div>
                </a>
                <div class="mt-2 text-muted">
                    <small>Desaigned and built with all the love ib the world by the
                        <a href="#" class="text-black">Bootstrab Team</a> with the help of
                        <a href="#" class="text-black">our contributors</a>
                    </small>
                </div>
            ...
            <div class="col-6 col-lg-2 mb-5">
                <h5>Projects</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="#">Boostrab 5</a></li>
                    <li class="mb-2"><a href="#">Boostrab 4</a></li>
                    <li class="mb-2"><a href="#">Icons</a></li>
            ...
            <div class="col-6 col-lg-2 mb-5">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#">stack overlow</a></li>
...
<?php /**PATH C:\Users\Dell\Documents\laravelRouting\resources\views/webproject.blade.php ENDPATH**/ ?>