...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/webproject')); ?>" class="list-group-item list-group-item-action">
                Tugas (Booststrab Clone)
            </a>
        </div>
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/route-list')); ?>" class="list-group-item list-group-item-action">
                <route:list>php artisan route:list</route:list>
            </a>
        </div>
    </div>
...
<?php /**PATH C:\Users\Dell\Documents\laravelRouting\resources\views/routing.blade.php ENDPATH**/ ?>